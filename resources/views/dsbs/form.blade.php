...
<fieldset class="">
    ...
    <div class="mb-3 row">
        <div class="col-sm-3">
            ...
            <select name="kd_kab" id="kd_kab" class="form-control select2-show-search form-select" required>
        ...
        <div class="col-sm-3">
            ...
            <select name="kd_kec" id="kd_kec" class="form-control select2-show-search form-select" required>
            </select>
        </div>
        <div class="col-sm-3">
            <label for="kd_desa" class="form-label">Kelurahan/Desa*</label>
            <select name="kd_desa" id="kd_desa" class="form-control select2-show-search form-select" required>
            </select>
        </div>
        <div class="col-sm-3">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-3">
            ...
            <input name="jml_rt" type="number" id="jml_rt" class="form-control" max="999999" min="0"
                oninput="checkInputLength(this)" value="{{ old('jml_rt', $data->jml_rt) }}">
        </div>
    </div>
