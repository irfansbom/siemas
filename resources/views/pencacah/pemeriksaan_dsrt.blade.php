...
@section('content')
    ...
    <div class="header2 ">
        <a href="{{ url('pcl_pemeriksaan_dsbs') }}" class="btn btn-transparent btn-sm border-0">
                    ...
                    <div class=" m-auto ">
                        @foreach ($dsrt as $rt)
                            <div class="row mb-3" style="widht:100%">
                                <div class="col">
                                    <a href="{{ url('pcl_pemeriksaan_ruta') . '/' . $rt->id }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-1 p-2  d-flex align-items-center justify-content-middle">
                                                @if ($rt->status_pencacahan < 4)
                                                    <i class="bi bi-bookmark-fill fs-2 "></i>
                                                @elseif($rt->status_pencacahan >= 4)
