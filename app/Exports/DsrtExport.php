    ...
    WithMapping
{
    ...
    public function headings(): array
    {
        $column = [
            ...
            'Keikutsertaan GSMP',
            'GSMP yang diterima',
            'Keikutsertaan Bantuan Sosial',
            'Bantuan Sosial yang diterima',
            'Jenis Pembayaran Listrik',
            'Daya Listrik Terpasang',
            'Besar Pemakaian kWh Listrik Sebulan Lalu',
            'Pengeluaran Listrik Sebulan Lalu (Rp)',
            'Keikutsertaan Sekolah Rakyat',
            'Keikutsertaan MBG',
            'Kualitas MBG',
            'Nasi campur/rames (R.196)',
            'Susu cair pabrik (R.79)',
