    ...
    public function update_dsrt(Request $request)
    {
        ...
        $affectedDsrt = Dsrt::updateOrCreate(
            ...
            [
                ...
                'listrik_jenis' => $data_dsrt->listrik_jenis,
                'listrik_daya' => $data_dsrt->listrik_daya,
                'listrik_kwh' => $data_dsrt->listrik_kwh,
                'listrik_harga' => $data_dsrt->listrik_harga,
                'sekolah_rakyat' => $data_dsrt->sekolah_rakyat,
                'mbg' => $data_dsrt->mbg,
                'menu_mbg' => $data_dsrt->menu_mbg,
                'rincian_int_1' => $data_dsrt->rincian_int_1,
                'rincian_int_2' => $data_dsrt->rincian_int_2,
